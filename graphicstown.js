...
window.onload = function() {
    ...
    var sliders = makeSliders([["TimeOfDay",0,48,24]]);
    ...
    var driveTheta = 0;
    var driveXTheta = 0;
    var orient = twgl.m4.rotationY(0);
    var ball = 1.0;
    ...
    function draw() {
        ...
        if (uiMode.value == "ArcBall") {
            ...
            twgl.m4.setTranslation(viewM, [0,0,-15], viewM);
            ...
            orient = twgl.m4.rotationY(driveTheta);
            ...
            cameraM = twgl.m4.rotationY(driveXTheta);
            orient = twgl.m4.rotationY(driveXTheta);
